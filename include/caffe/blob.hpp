...
class Blob {
 public:
  ...
  const Dtype* new_aicore_data();
  const Dtype* cpu_diff() const;
  const Dtype* gpu_diff() const;
  std::string aicore_diff();
  const Dtype* new_aicore_diff();
  Dtype* mutable_cpu_data();
  Dtype* mutable_gpu_data();
  std::string mutable_aicore_data();
  Dtype* new_mutable_aicore_data();
  Dtype* mutable_cpu_diff();
  Dtype* mutable_gpu_diff();
  std::string mutable_aicore_diff();
  Dtype* new_mutable_aicore_diff();
  void Update();
