...
void classname<Dtype, Wtype>::Forward_gpu(const vector<Blob<Dtype, Wtype>*>& bottom, \
    const vector<Blob<Dtype, Wtype>*>& top) { NO_GPU; } \
template <typename Dtype, typename Wtype> \
void classname<Dtype, Wtype>::Backward_gpu(const vector<Blob<Dtype, Wtype>*>& top, \
    const vector<bool>& propagate_down, \
    const vector<Blob<Dtype, Wtype>*>& bottom) { NO_GPU; } \

#define STUB_GPU_FORWARD(classname, funcname) \
template <typename Dtype, typename Wtype> \
void classname<Dtype, Wtype>::funcname##_##gpu(const vector<Blob<Dtype, Wtype>*>& bottom, \
    const vector<Blob<Dtype, Wtype>*>& top) { NO_GPU; } \

#define STUB_GPU_BACKWARD(classname, funcname) \
template <typename Dtype, typename Wtype> \
void classname<Dtype, Wtype>::funcname##_##gpu(const vector<Blob<Dtype, Wtype>*>& top, \
    const vector<bool>& propagate_down, \
    const vector<Blob<Dtype, Wtype>*>& bottom) { NO_GPU; } \
