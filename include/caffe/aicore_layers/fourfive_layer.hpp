#ifndef CAFFE_FOURFIVE_LAYER_HPP_
#define CAFFE_FOURFIVE_LAYER_HPP_
...
class FourFiveLayer : public Layer<Dtype> {
 public:
  explicit FourFiveLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);

  virtual inline const char* type() const { return "FourFive"; }
...
#endif  // CAFFE_FOURFIVE_LAYER_HPP_
