...
if(USE_OPENCV)
  if(CROSS_BUILD)
    list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${CMAKE_FIND_ROOT_PATH}/usr/include/opencv)
    list(APPEND Caffe_LINKER_LIBS PUBLIC ${CMAKE_FIND_ROOT_PATH}/usr/lib/aarch64-linux-gnu/libopencv_core.so)
    list(APPEND Caffe_LINKER_LIBS PUBLIC ${CMAKE_FIND_ROOT_PATH}/usr/lib/aarch64-linux-gnu/libopencv_highgui.so)
    list(APPEND Caffe_LINKER_LIBS PUBLIC ${CMAKE_FIND_ROOT_PATH}/usr/lib/aarch64-linux-gnu/mesa/libGL.so.1)
